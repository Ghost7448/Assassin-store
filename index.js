...
شكرا لتعاملك معنا ❤️
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription('**نشكرك على وقتك وثقتك بنا ونرجو منك تقييم تجربتك معنا من خلال الأزرار الموجودة بالأسفل آراؤكم محل اهتمام كبير لدينا حيث تساعدنا بشكل مباشر على تحسین جودة الخدمة وتطوير الأدا بشكل مستمر لتقديم تجربة أفضل للجميع لا تتردد في اختيار التقييم الذي يعكس تجربتك بكل شفافية**')
